...
var star1, star2, starImg, counter;
var empty, one, two;
...
function setup() {
  ...
  star1 = createSprite(280, 40);
  star1.addImage(starImg);
  star1.scale = 0.02;

  star2 = createSprite(80, 330);
  star2.addImage(starImg);
  star2.scale = 0.02;

  counter=createSprite(50,30);
  counter.addAnimation("empty",empty)
  counter.addAnimation("one",one)
  counter.addAnimation("two",two)
  counter.scale=0.2
...
function draw() {
  ...
  if (collide(fruit, star1, 20) === true) {
    star1.visible = false;
    counter.changeAnimation("one");
  }

  if (collide(fruit, star2, 20) === true) {
    star2.visible = false;
    if(star1.visible===false){
    counter.changeAnimation("two");
    }
    else{
      counter.changeAnimation("one");
    }
